...
// Constant Time O(n): (O)1 No matter the size of your input, the algorithm will take the same amount of time to complete.
...
// Linear time: O(1) Algorithms with linear time complexity (O(n)) have running times that are
